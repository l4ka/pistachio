...
typedef L4_Word64_t		uint64_t;
typedef L4_Word32_t		uint32_t;
typedef L4_Word16_t		uint16_t;
typedef int __attribute__((__mode__(__DI__)))	int64_t;
typedef int __attribute__((__mode__(__SI__)))	int32_t;
typedef int __attribute__((__mode__(__HI__)))	int16_t;
